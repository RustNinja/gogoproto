...
var fileDescriptor_292007bbfe81227e = []byte{
	...
	0x14, 0x4b, 0x30, 0x2a, 0x30, 0x6a, 0x08, 0x04, 0xc1, 0xb8, 0x42, 0x22, 0x5c, 0xac, 0x79, 0x89,
	0x79, 0xf9, 0xc5, 0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0xfc, 0x41, 0x10, 0x8e, 0x53, 0x03, 0xe3, 0x8d,
	...
	0xca, 0x24, 0x36, 0xb0, 0x61, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x4e, 0x66, 0x52, 0x3d,
	0xfa, 0x00, 0x00, 0x00,
}
...
func (m *Timestamp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Seconds = int64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
		case 2:
			if wireType != 5 {
			...
			m.Nanos = int32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
		default:
			iNdEx = preIndex
